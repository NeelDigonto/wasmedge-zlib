...
typedef z_stream
    *z_streamp; /* Obsolete type, retained for compatibility only */
...
typedef struct gz_header_s {
  ...
  int done; /* true when done reading gzip header (not used when writing a gzip
               file) */
} gz_header;
...
#define Z_NULL                                                                 \
  NULL /* for compatibility with zlib, was for initializing zalloc, zfree,     \
          opaque */
...
Z_EXTERN int Z_EXPORT deflateGetDictionary(z_stream *strm,
...
Z_EXTERN int Z_EXPORT deflateTune(z_stream *strm, int good_length, int max_lazy,
...
Z_EXTERN unsigned long Z_EXPORT deflateBound(z_stream *strm,
...
Z_EXTERN int Z_EXPORT deflatePending(z_stream *strm, uint32_t *pending,
                                     int *bits);
/*
...
Z_EXTERN int Z_EXPORT inflateSetDictionary(z_stream *strm,
                                           const unsigned char *dictionary,
                                           unsigned int dictLength);
/*
...
Z_EXTERN int Z_EXPORT inflateGetDictionary(z_stream *strm,
                                           unsigned char *dictionary,
                                           unsigned int *dictLength);
/*
...
/*
Z_EXTERN int Z_EXPORT inflateBackInit (z_stream *strm, int windowBits, unsigned
char *window);
...
Z_EXTERN int Z_EXPORT inflateBack(z_stream *strm, in_func in, void *in_desc,
...
/* Return flags indicating compile-time options.
    ...
    One-time table building (smaller code, but not thread-safe if true):
     12: BUILDFIXED -- build static block decoding tables when needed (not
   supported by zlib-ng) 13: DYNAMIC_CRC_TABLE -- build CRC calculation tables
   when needed 14,15: 0 (reserved)
...
Z_EXTERN int Z_EXPORT compress(unsigned char *dest, unsigned long *destLen,
...
Z_EXTERN int Z_EXPORT compress2(unsigned char *dest, unsigned long *destLen,
                                const unsigned char *source,
...
Z_EXTERN int Z_EXPORT uncompress(unsigned char *dest, unsigned long *destLen,
                                 const unsigned char *source,
                                 unsigned long sourceLen);
/*
...
Z_EXTERN size_t Z_EXPORT gzfread(void *buf, size_t size, size_t nitems,
                                 gzFile file);
/*
...
Z_EXTERN size_t Z_EXPORT gzfwrite(void const *buf, size_t size, size_t nitems,
                                  gzFile file);
/*
...
Z_EXTERN unsigned long Z_EXPORT adler32(unsigned long adler,
...
Z_EXTERN unsigned long Z_EXPORT adler32_z(unsigned long adler,
...
/*
Z_EXTERN unsigned long Z_EXPORT adler32_combine(unsigned long adler1, unsigned
long adler2, z_off_t len2);
...
Z_EXTERN unsigned long Z_EXPORT crc32(unsigned long crc,
                                      const unsigned char *buf,
                                      unsigned int len);
/*
...
Z_EXTERN unsigned long Z_EXPORT crc32_z(unsigned long crc,
                                        const unsigned char *buf, size_t len);
/*
...
/*
Z_EXTERN unsigned long Z_EXPORT crc32_combine(unsigned long crc1, unsigned long
crc2, z_off64_t len2);
...
Z_EXTERN int Z_EXPORT inflateInit_(z_stream *strm, const char *version,
                                   int stream_size);
Z_EXTERN int Z_EXPORT deflateInit2_(z_stream *strm, int level, int method,
                                    int windowBits, int memLevel, int strategy,
                                    const char *version, int stream_size);
Z_EXTERN int Z_EXPORT inflateInit2_(z_stream *strm, int windowBits,
                                    const char *version, int stream_size);
Z_EXTERN int Z_EXPORT inflateBackInit_(z_stream *strm, int windowBits,
...
Z_EXTERN unsigned long Z_EXPORT adler32_combine64(unsigned long, unsigned long,
                                                  z_off64_t);
Z_EXTERN unsigned long Z_EXPORT crc32_combine64(unsigned long, unsigned long,
                                                z_off64_t);
...
Z_EXTERN unsigned long Z_EXPORT adler32_combine(unsigned long, unsigned long,
                                                z_off_t);
Z_EXTERN unsigned long Z_EXPORT crc32_combine(unsigned long, unsigned long,
                                              z_off_t);
